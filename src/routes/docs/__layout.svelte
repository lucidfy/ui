<script lang="ts">
  ...
  let selectedTheme = writable('')
  setContext('themeChange', selectedTheme)
...
<div class="nav w-full">
  <div class="flex justify-end">
    <Theme on:change={themeChanged} />
  </div>
</div>

<div class="raleway flex container mx-auto w-9/12">
  <div class="w-3/12">
    <SideBar />
  </div>
  <div class="w-9/12 max-w-9/12">
    <slot />
  </div>
</div>
...
<footer class="footer footer-center mt-10 p-10 bg-base-200 text-base-content rounded">
  <div class="grid grid-flow-col gap-4">
    <a href="/" class="link link-hover">Search Jobs</a>
  </div>
  <div>
    <div class="grid grid-flow-col gap-4">
      <a href="/"
